...
export default defineConfig({
  ...
  projects: [
    { name: "chromium", use: { ...devices["Desktop Chrome"], extraHTTPHeaders: { "x-real-ip": "192.0.2.1" } } },
    { name: "firefox", use: { ...devices["Desktop Firefox"], extraHTTPHeaders: { "x-real-ip": "192.0.2.2" } } },
    { name: "webkit", use: { ...devices["Desktop Safari"], extraHTTPHeaders: { "x-real-ip": "192.0.2.3" } } },
    { name: "mobile-chromium", use: { ...devices["Pixel 5"], extraHTTPHeaders: { "x-real-ip": "192.0.2.4" } } },
  ],
  webServer: {
